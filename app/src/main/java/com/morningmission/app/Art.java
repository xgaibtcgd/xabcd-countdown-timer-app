...
final class Art {
    ...
    // The destination at the end of the lane used to be eight hand-authored goals, one
    // per character -- a picnic basket, a hive, a doghouse, a treasure chest, a nest, a
    // rainbow, a present, a volcano. They are all one shared treasure chest now, drawn
    // from a bitmap (MorningView.PROP_CHEST_*), so the geometry that was here is gone
    // rather than left sitting unused. Git has it if it is ever wanted back.
